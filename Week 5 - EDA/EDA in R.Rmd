...
Ok, 58 seems to be the MAX and MODAL number of entries. Let's see how many countries meet that criteria by visualizing the count data table as a histogram.
```{r echo=TRUE}
gapminder_unfiltered %>% 
   count(country) %>% 
   ggplot(aes(n)) +
